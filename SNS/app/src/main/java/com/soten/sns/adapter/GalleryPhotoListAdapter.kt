...
import com.soten.sns.databinding.ItemGalleryPhotoBinding
import com.soten.sns.extension.loadCenterCrop
import com.soten.sns.gallery.GalleryPhoto
...
class GalleryPhotoListAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PhotoItemViewHolder {
        val view = ItemGalleryPhotoBinding.inflate(LayoutInflater.from(parent.context), parent, false)
