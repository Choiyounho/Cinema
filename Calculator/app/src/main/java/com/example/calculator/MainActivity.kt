...
class MainActivity : AppCompatActivity() {
    ...
    private val expressionTextView: TextView by lazy {
        findViewById(R.id.expressionTextView_history)
    }

    private val resultTextView: TextView by lazy {
        findViewById(R.id.resultTextView_history)
    }
        ...
        Thread(Runnable {
            db.historyDao().getAll().reversed().forEach {
                runOnUiThread {
                    ...
                    historyView.findViewById<TextView>(R.id.expressionTextView_history).text = it.expression
                    historyView.findViewById<TextView>(R.id.resultTextView_history).text = " ${it.result}"
