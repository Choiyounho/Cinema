...
data class AddressInfo(
    ...
    fun toSearchInfoEntity(locationLatLngEntity: LocationLatLngEntity) = MapSearchInformationEntity(
        fullAddress = fullAddress ?: "존재하지 않는 주소 입니다.",
        name = buildingName ?: "빌딩 정보가 없습니다.",
