...
import com.soten.moviereview.databinding.ItemFeaturedMovieBinding
import com.soten.moviereview.databinding.ItemMovieBinding
...
class HomeAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    inner class FeaturedMovieItemViewHolder(private val binding: ItemFeaturedMovieBinding) :
        ...
        fun bind(item: FeaturedMovie) {
            ...
            binding.scoreCountTextView.text = item.movie.numberOfScore?.toAbbreviatedString() // 1000 개가 넘은 2100 일 시 2.1k로 표현
