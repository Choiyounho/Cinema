package com.soten.dustapp.appwidget
    ...
    class UpdateWidgetService : LifecycleService() {
        ...
        override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
            if (ActivityCompat.checkSelfPermission(
                ...
                val updateWViews = RemoteViews(packageName, R.layout.widget_simple).apply {
                    setTextViewText(
                        R.id.resultTextView,
                        "권한 없음"
                    )
        ...
        private fun updateWidget(updateViews: RemoteViews) {
            val widgetProvider = ComponentName(this, AirQualityWidgetProvider::class.java)
